...
use ~/.config/nushell/completions/tldr-completions.nu *
use ~/.config/nushell/completions/pass/pass-completions.nu *
...
# Source this in after initialization because otherwise config will get overwritten
